...
export const Footer: FC = () => {
    return (
        <div className="">
            <footer className="mx-auto  flex flex-row p-3 text-center items-center footer bg-neutral text-neutral-content">
                ...
                <div className="max-w-md mx-auto sm:pl-12 grid-flow-col gap-4 text-center">
                    <Link href="https://github.com/a-yo-defi">
                    <a>
                    ...
                    <Link href="https://twitter.com/a_yo_defi">
                    <a>
